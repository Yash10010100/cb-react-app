...
const CustomRegistrationForm = ({
  ...
  isPreview = false,
  eventDetails = {
    title: 'Hack the Campus 2024',
    desc: 'Please fill out the details below to secure your spot at the annual university hackathon.',
    image: 'https://via.placeholder.com/600x200?text=CAMPUS+EVENT'
  },
  onSelectField = () => { },
            ...
            return (
              ...
              >
                ...
                {field.datatype === 'Options' ? (
                  ...
                  <input
                    type={typeMap[field.datatype] || 'text'}
                    {...register(field.name, { required: field.required })}
